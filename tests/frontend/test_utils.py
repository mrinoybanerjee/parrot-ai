""" Tests for the utility functions in the frontend module. """
...
def test_initialize_session_state(mock_streamlit):
    """
    Test the initialize_session_state function to ensure it sets up the
...
def test_show_messages(mock_streamlit):
    ...
    mesg_1 = {"role": "Customer", "content": "नमस्ते", "translation": "Hello",
              "language": "Hindi"}
    mesg_2 = {"role": "Waitstaff", "content": "स्वागत है", "translation": "Welcome",
              "language": "Hindi"}
    # Call show_messages and capture the message counter
    message_counter = show_messages(
        mesg_1, mesg_2, message_counter=0, time_delay=0, batch=True,
